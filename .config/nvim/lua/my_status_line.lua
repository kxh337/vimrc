...
gls.left[1] = {
	ViMode = {
		provider = function()
			...
			highlight("GalaxyFileIcon", fileinfo.get_file_icon_color() or c.main_fg, c.dimmer_bg)
...
gls.right[6] = { -- trailing indicator
	Whitespace = {
		provider = function()
...
-- inactive window or shortline
gls.short_line_left[1] = { -- File type
  BufferType = {
...
gls.short_line_left[2] = { -- File Name
  BufferName = {
		provider = 'SFileName',
...
gls.short_line_right[1] = { -- Buffer Icon
  BufferIcon = {
		provider = function()
			return ' ' .. fileinfo.get_file_icon()
		end,
